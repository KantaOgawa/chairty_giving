---
title: "Regression with IV: The positive attitude toward Equality in the manifesto of the prime parties"
author: Kanta Ogawa
date: "2022 / 03 / 15"
...
###### pattern 4- Equallity_pos

ivreg_unbalance_rel_redist_grants_4 <- ivreg(Grants_by_private_agencies_and_NGOs ~ 1 + Relative_redistributive_effects
  + Poverty_rate
...
GINI_1_4 <- coeftest(ivreg_unbalance_rel_redist_grants_4, vcov = vcovHC, type = "HC3")
...
###### pattern4- Equality_pos

ivreg_unbalance_rel_redist_priv_4 <- ivreg(log_Private_transfer ~ 1
+ Relative_redistributive_effects
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
GINI_2_4 <- coeftest(ivreg_unbalance_rel_redist_priv_4, vcov = vcovHC, type = "HC3")
...
ivreg_unbalance_rel_redist_WGI_4 <- ivreg(Giving_money ~ 1 + Relative_redistributive_effects
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
  + Chrstcatpct
...
GINI_3_4 <- coeftest(ivreg_unbalance_rel_redist_WGI_4, vcov = vcovHC, type = "HC3") # revise
...
###### pattern 4- Equality_pos
ivreg_unbalance_grants_pub_4 <- ivreg(Grants_by_private_agencies_and_NGOs ~ 1
+ Public_transfer
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
Public_4_4 <- coeftest(ivreg_unbalance_grants_pub_4, vcov = vcovHC, type = "HC3")
...
##### pattern4 - Equality_pos
ivreg_unbalance_priv_pub_4 <- ivreg(log_Private_transfer ~ 1 + Public_transfer +
  +Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
  + Chrstcatpct
...
Public_5_4 <- coeftest(ivreg_unbalance_priv_pub_4, vcov = vcovHC, type = "HC3")
...
ivreg_unbalance_pub_WGI_4 <- ivreg(Giving_money ~ 1
+ Public_transfer
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
Public_6_4 <- coeftest(ivreg_unbalance_pub_WGI_4, vcov = vcovHC, type = "HC3")
...
ivreg_unbalance_netpub_grants_4 <- ivreg(Grants_by_private_agencies_and_NGOs ~ 1 +
  Net_public_transfer
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
Netpub_10_4 <- coeftest(ivreg_unbalance_netpub_grants_4, vcov = vcovHC, type = "HC3")
...
ivreg_unbalance_netpub_priv_4 <- ivreg(log_Private_transfer ~ 1 +
  Net_public_transfer
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
Netpub_11_4 <- coeftest(ivreg_unbalance_netpub_priv_4, vcov = vcovHC, type = "HC3")
...
ivreg_unbalance_netpub_WGI_4 <- ivreg(Giving_money ~ 1 +
  Net_public_transfer
  + Poverty_rate
  + Unemployment_rate_pct
  + Chrstprotpct
...
Netpub_12_4 <- coeftest(ivreg_unbalance_netpub_WGI_4, vcov = vcovHC, type = "HC3")
...
stargazer(GINI_1_4, GINI_2_4, GINI_3_4, Public_4_4, Public_5_4, Public_6_4, Netpub_10_4, Netpub_11_4, Netpub_12_4,
  keep = c(
  ...
  type = "html",
  title =  "Regression: IV Estimation: The positive attitude toward Equality of the prime parties",
...
stargazer(GINI_1_4, GINI_2_4, GINI_3_4, Public_4_4, Public_5_4, Public_6_4, Netpub_10_4, Netpub_11_4, Netpub_12_4,
  ...
  type = "latex",
  out = "../Code/f.IV-Equality_pos_new.tex",
  title =  "Regression: IV Estimation: The positive attitude toward Equality of the prime parties",
  column.labels = c("Grants by private agencies and NGOs", "log Private transfer", "Giving money index", "Grants by private agencies and NGOs", "log Private transfer", "Giving money index", "Grants by private agencies and NGOs", "log Private transfer", "Giving money index"),
  dep.var.caption = "Target variables",
  add.lines = list(
